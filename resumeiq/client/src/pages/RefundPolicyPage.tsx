            ...
            <main className="flex-1 max-w-4xl mx-auto px-6 py-16 w-full">
                ...
                <div className="bg-[#13131A]/80 backdrop-blur-xl p-8 md:p-12 rounded-[32px] border border-white/5 shadow-2xl space-y-8 text-gray-400 leading-relaxed text-sm">
                    <section>
                        ...
                        <p>We offer a 7-day money-back guarantee for all our premium plans. If you are not satisfied with our AI features, you can request a full refund within 7 days of your initial purchase.</p>
                    </section>
                    <section>
                        <h2 className="text-lg font-bold text-white mb-2">2. How to Request a Refund</h2>
                        <p>To request a refund, please contact our support team at <a href="mailto:support@joinhyrr.com" className="text-[#5B5FEF] hover:underline">support@joinhyrr.com</a> with your account email and transaction ID.</p>
                    </section>
                </div>
            </main>
