    ...
    return (
        <div className="min-h-screen bg-[#0A0A0F] text-[#EEEEF0] flex flex-col">
            ...
            <main className="flex-1 max-w-4xl mx-auto px-6 py-16 w-full">
                <h1 className="text-4xl font-black mb-8">Help & Support</h1>
                <div className="bg-[#13131A]/80 backdrop-blur-xl p-8 md:p-12 rounded-[32px] border border-white/5 shadow-2xl space-y-8 text-gray-400 leading-relaxed text-sm">
                    <section>
                        <h2 className="text-lg font-bold text-white mb-2">How can we help?</h2>
                        <p>Need assistance with your account, billing, or using our tools? Check out our FAQs on the home page or reach out to our support team.</p>
                        <p className="mt-4">Contact Support: <a href="mailto:help@joinhyrr.com" className="text-[#5B5FEF] hover:underline">help@joinhyrr.com</a></p>
                    </section>
                </div>
            </main>
