...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-hyrr-background text-white font-sans overflow-hidden">
      {/* Sidebar */}
      <aside className="w-[240px] flex-shrink-0 bg-hyrr-surface border-r border-white/[0.05] flex flex-col">

        {/* Logo Section */}
        <div className="flex items-center gap-3 px-6 py-8">
          <div className="w-10 h-10 bg-[#5B5FEF] rounded-xl flex items-center justify-center shadow-lg shadow-[#5B5FEF]/20 transition-transform hover:scale-105">
        ...
        <nav className="flex-1 px-4 space-y-1">
          <p className="text-[10px] font-mono text-gray-600 uppercase tracking-widest px-2 mb-3">Workspace</p>
          ...
          {isAdmin && (
            <div className="mt-8">
              <p className="text-[10px] font-mono text-gray-600 uppercase tracking-widest px-2 mb-3">Admin Control</p>
              <NavLink
                to="/admin"
                className={({ isActive }) =>
        ...
        <div className="p-4 bg-black/20 m-4 rounded-2xl border border-white/[0.03]">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 rounded-xl bg-[#5B5FEF]/20 border border-[#5B5FEF]/30 flex items-center justify-center text-sm font-bold text-[#5B5FEF]">
